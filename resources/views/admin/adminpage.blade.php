            ...
            <div style="text-align:center;">
                ...
                <div class="responsive-account-content">
                        <section class="collapsable-section-content account-section-content">
                            ...
                            <a class="btn hero-cta-btn btn-large btn-yellow" role="link" style="min-width:256px;" href="/admin/deleteSerie">Eliminar serie</a>
                            <a class="btn hero-cta-btn btn-large btn-yellow" role="link" style="min-width:256px;" href="/admin/newCategory">Añadir Genero</a>
                            <a class="btn hero-cta-btn btn-large btn-yellow" role="link" style="min-width:256px;" href="/admin/deleteCategory">Eliminar Genero</a>
                            ...
                            <a class="btn hero-cta-btn btn-large btn-yellow" role="link" style="min-width:256px;" href="/admin/newMovie">Añadir Pelicula</a>
                            <a class="btn hero-cta-btn btn-large btn-yellow" role="link" style="min-width:256px;" href="/admin/editMovie">Editar Pelicula</a>
                            ...
                            <a class="btn hero-cta-btn btn-large btn-yellow" role="link" style="min-width:256px;" href="/admin/deleteMovie">Eliminar pelicula</a>
