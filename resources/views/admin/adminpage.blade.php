            ...
            <div style="text-align:center;">
                ...
                <div class="responsive-account-content">
                        <section class="collapsable-section-content account-section-content">
                            <a class="btn hero-cta-btn btn-large btn-yellow" role="link" style="min-width:256px;" href="{{route('verserie.index')}}">Administrar series</a><br>
                            <a class="btn hero-cta-btn btn-large btn-yellow" role="link" style="min-width:256px;" href="{{route('addgenre')}}">Añadir Genero</a>
                            <a class="btn hero-cta-btn btn-large btn-yellow" role="link" style="min-width:256px;" href="{{route('deletegenre')}}">Eliminar Genero</a><br/>
